...
main ()
{
  ...
  gpg_key_url="https://packagecloud.io/j842/main/gpgkey"
  apt_config_url="https://packagecloud.io/install/repositories/j842/main/config_file.list?os=any&dist=any&source=script"

  apt_source_path="/etc/apt/sources.list.d/j842_main.list"
  gpg_keyring_path="/usr/share/keyrings/j842_main-archive-keyring.gpg"
  ...
  then
    ...
    mv ${gpg_keyring_path} /etc/apt/trusted.gpg.d/j842_main.gpg
  fi
  echo "done."
